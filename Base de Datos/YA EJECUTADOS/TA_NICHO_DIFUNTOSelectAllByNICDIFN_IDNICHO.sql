...
GO
IF EXISTS (SELECT * FROM dbo.sysobjects where id = object_id(N'[dbo].[TA_NICHO_DIFUNTOSelectAllByNICDIFN_IDNICHO]') and ObjectProperty(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[TA_NICHO_DIFUNTOSelectAllByNICDIFN_IDNICHO]
GO

/******************************************************************************
NOMBRE           : TA_NICHO_DIFUNTOSelectAllByNICDIFN_IDNICHO
...
SINTAXIS         :  
            TA_NICHO_DIFUNTOSelectAllByNICDIFN_IDNICHO
******************************************************************************/
CREATE PROCEDURE [dbo].[TA_NICHO_DIFUNTOSelectAllByNICDIFN_IDNICHO]
(
    	@NICDIFN_IDNICHO INT
)
...
BEGIN
    ...
    WHERE     ND.[NICDIFN_IDNICHO] = @NICDIFN_IDNICHO
	AND ND.[NICDIFB_ESTADO] = 1
END
